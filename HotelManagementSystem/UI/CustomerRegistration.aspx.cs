        ...
        #region All Methods
            ...
            private void GetNextCustomerCode()
            {
                try
                {
                    ...
                    txtCustomerCode.Text = customerCode.ToString("CC-000");
                }
                catch (Exception ex)
                {
                    throw ex;
            ...
            private string GetNextRoomServiceToCustID()
            {
                try
                {
                    ...
                    return roomServiceToCustID.ToString("RSC-000");
                }
                catch (Exception ex)
                {
                    throw ex;
                ...
                try
                {
                    if (rbtLstCustomer.SelectedValue == "New Customer")
                    {
                        ...
                        else
                        {
                            ...
                            oRoomServiceToCustomer.ArrivalDate = DateTime.Now;
                            //oRoomServiceToCustomer.DepartureDate = null;
                            oRoomServiceToCustomer.TotalRoomRent = lblRoomRent.Text;
                            oRoomServiceToCustomer.PurposeOfArrival = txtPuposeOfJourney.Text;
                            oRoomServiceToCustomer.Status = "Active";
                    ...
                    else
                    {
                        ...
                        oRoomServiceToCustomer.RoomCode = ddlRoomCode.SelectedValue;
                        oRoomServiceToCustomer.ArrivalDate = DateTime.Now;
                        //oRoomServiceToCustomer.DepartureDate = Convert.ToDateTime("");
                        oRoomServiceToCustomer.TotalRoomRent = lblRoomRent.Text;
                        oRoomServiceToCustomer.PurposeOfArrival = txtPuposeOfJourney.Text;
                        oRoomServiceToCustomer.Status = "Active";
